KEYS_KINOPOISK_API_UNOFFICIAL = [
    '3cdf0f0f-62f5-4840-b0d6-3f0a047f3dcb', '44535d0b-6460-4480-ab4c-c4ff53dbccf0',
...
API_UNOFFICIAL_ENDPOINT = 'https://kinopoiskapiunofficial.tech/api/v2.2/films/'
API_UNOFFICIAL_KEY_HEADER = 'X-API-KEY'
API_KINOBD = 'https://kinobd.net/api/films/search/kp_id?q='
USER_AGENT_HEADER = {'User-Agent': 'Rock'}
